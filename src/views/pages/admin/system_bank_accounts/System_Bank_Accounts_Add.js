...
class System_Bank_Accounts_Add extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: {
        ...
        country_code: "",
        status: false,
        operation_type: "system_bank_account_add",
      },
      countryData: [],
    };
    ...
    return (
      <CRow>
        <CCol xs="12">
          <CCard>
            <CCardHeader>
              <strong>Add System Bank Account</strong>
            </CCardHeader>
            <CCardBody>
              <CFormGroup>
...
export default System_Bank_Accounts_Add;
