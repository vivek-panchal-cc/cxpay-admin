...
class BusinessCustomersReviewNeededKycIndex extends React.Component {
  constructor(props) {
    super(props);
      ...
      <>
        ...
        <CRow>
          <CCol xl={12}>
            <CCard>
              <CCardHeader>
                <strong>Business Customers In Review KYC</strong>
...
export default BusinessCustomersReviewNeededKycIndex;
