...
const useGetBusinessManualRequestForReport = ({
  page = 1,
  search = "",
  status = [],
  start_date = "",
  ...
  const retrieveListActivities = async (
    ...
    try {
      const response = await businessCustomersService.getCustomerWiseDetails({
        page,
        search,
        status,
        start_date,
...
export default useGetBusinessManualRequestForReport;
