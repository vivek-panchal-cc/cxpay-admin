...
class Customer_Management_Merchant_Fees_Report extends React.Component {
  constructor(props) {
    super(props);
    ...
    const downloadFile = async () => {
      try {
        const { data, message, success } =
          await customersManagementService.downloadMerchantFeesReportData(
            this.state.fields
          );
...
export default Customer_Management_Merchant_Fees_Report;
